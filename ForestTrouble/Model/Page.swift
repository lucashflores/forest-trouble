...
struct Page: Identifiable {
    ...
    static func getPages() -> [Page] {
        return [
            ...
            Page(id: "intro6", illustration: "castle", firstButton: "continue_button", firstDestination: "chapter11", textContent: "This is how it all started..."),
            ...
            Page(id: "chapter131", illustration: "life", firstButton: "continue_button", firstDestination: "chapter14", textContent: "There isn't much to see in the house but you see some wooden toys, a red woolen scarf that is not yet done and a fireplace starting do die out."),
            ...
            Page(id: "neutral-ending", illustration: "life", firstButton: "restart_button", firstDestination: "intro1", textContent: "You manage to escape but not unscathed. You failed to investigate the disappearings."),
            ...
            Page(id: "chapter16", illustration: "life", firstButton: "continue_button", firstDestination: "17", textContent: "After hours of walking, you finally reach their camp. You first observe it without being seen to strategize your course of action. You see the children in a prison in the farthest part of the camp and you also see an orc!"),
            Page(id: "chapter17", illustration: "life", firstButton: "continue", firstDestination: "orc-fight", textContent: "The orc is the leader of the goblin camp and if you are able to win against him in a test of strength, you can leave without having to fight the goblins."),
            Page(id: "orc-fight", illustration: "life", firstButton: "left_button", firstDestination: "good-ending", secondButton: "right_button", secondDestination: "bad-ending", textContent: "Orc Fight", isCombat: true, combatResources: CombatResources(enemies: [Orc()])),
            Page(id: "good-ending", illustration: "life", firstButton: "restart_button", firstDestination: "intro1", textContent: "You emerge victorious from the fight and manage to rescue the children and return them to their parents. The residents of the village and the queen personally thanks you."),
            Page(id: "bad-ending", illustration: "life", firstButton: "restart_button", firstDestination: "win-orc-fight", textContent: "You failed to defeat the orc and you died."),
